...
# Output folder
##################################################
output_path <- file.path("/storage/htc/joshilab/yenc/projects/03_27_2021_aWGCNA/WGCNA_RNAi_output")
...
datTraits <- datTraits[startsWith(rownames(datTraits), "RNAi"),]
datTraits2 <- datTraits2[startsWith(rownames(datTraits2), "RNAi"),]
datTraits3 <- datTraits3[startsWith(rownames(datTraits3), "RNAi"),]
datTraits4 <- datTraits4[startsWith(rownames(datTraits4), "RNAi"),]
