...
datTraits <- datTraits[startsWith(rownames(datTraits), "Col"),]
datTraits2 <- datTraits2[startsWith(rownames(datTraits2), "Col"),]
datTraits3 <- datTraits3[startsWith(rownames(datTraits3), "Col"),]
datTraits4 <- datTraits4[startsWith(rownames(datTraits4), "Col"),]
